...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 84; i <= 90; ++i) start[i] = 8;
		for (int i = 95; i <= 95; ++i) start[i] = 8;
		for (int i = 97; i <= 99; ++i) start[i] = 8;
		for (int i = 101; i <= 101; ++i) start[i] = 8;
		for (int i = 103; i <= 109; ++i) start[i] = 8;
		for (int i = 112; i <= 115; ++i) start[i] = 8;
		for (int i = 117; i <= 122; ++i) start[i] = 8;
		for (int i = 48; i <= 57; ++i) start[i] = 51;
		start[126] = 1; 
		start[58] = 2; 
		start[44] = 3; 
		start[123] = 4; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 48:
				{t.kind = 13; break;}
			case 49:
				if (ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 50;}
				else {goto case 0;}
			case 50:
				recEnd = pos; recKind = 14;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 50;}
			...
			case 52:
				if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); goto case 52;}
			...
			case 55:
				...
				else if (ch == 'p') {AddCh(); goto case 60;}
				else {goto case 0;}
			case 56:
			...
			case 58:
				if (ch == '"' || ch == '/' || ch == 92 || ch == 'b' || ch == 'f' || ch == 'n' || ch == 'r' || ch == 't') {AddCh(); goto case 52;}
				else if (ch == 'u') {AddCh(); goto case 11;}
				else {goto case 0;}
			case 59:
			...
			case 83:
				if (ch == 'Z' || ch == 'z') {AddCh(); goto case 48;}
			...
			case 86:
				recEnd = pos; recKind = 13;
				if (ch == 'T' || ch == 't') {AddCh(); goto case 88;}
				else {t.kind = 13; break;}
			case 87:
			...
			case 91:
				if (ch >= '0' && ch <= '9') {AddCh(); goto case 32;}
				else if (ch == 'Z' || ch == 'z') {AddCh(); goto case 48;}
				else if (ch == '+' || ch == '-') {AddCh(); goto case 33;}
				else {goto case 0;}
			case 92:
			...
			case 102:
				if (ch == 'Z' || ch == 'z') {AddCh(); goto case 48;}
				else if (ch == '+' || ch == '-') {AddCh(); goto case 43;}
				else {goto case 0;}
			case 103:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'r') {AddCh(); goto case 112;}
				else {goto case 0;}
			case 104:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'b' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'a') {AddCh(); goto case 113;}
				else {goto case 0;}
			case 105:
			...
			case 106:
				...
				else if (ch == 'n') {AddCh(); goto case 115;}
				else {goto case 0;}
			case 107:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 't') {AddCh(); goto case 116;}
				else {goto case 0;}
			case 108:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
			...
			case 111:
				...
				else if (ch == 'a') {AddCh(); goto case 120;}
				else {goto case 0;}
			case 112:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 't' || ch >= 'v' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'u') {AddCh(); goto case 121;}
				else {goto case 0;}
			case 113:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'k' || ch >= 'm' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'l') {AddCh(); goto case 122;}
				else {goto case 0;}
			case 114:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'k' || ch >= 'm' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
			...
			case 115:
				...
				else if (ch == 'y') {AddCh(); goto case 124;}
				else {goto case 0;}
			case 116:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
			...
			case 117:
				...
				else if (ch == 't') {AddCh(); goto case 126;}
				else {goto case 0;}
			case 118:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'o') {AddCh(); goto case 127;}
				else {goto case 0;}
			case 119:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'o') {AddCh(); goto case 128;}
				else {goto case 0;}
			case 120:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 't') {AddCh(); goto case 129;}
				else {goto case 0;}
			case 121:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'e') {AddCh(); goto case 130;}
				else {goto case 0;}
			case 122:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 's') {AddCh(); goto case 131;}
				else {goto case 0;}
			case 123:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'k' || ch >= 'm' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'l') {AddCh(); goto case 132;}
				else {goto case 0;}
			case 124:
			...
			case 125:
				...
				else if (ch == 'i') {AddCh(); goto case 133;}
				else {goto case 0;}
			case 126:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
			...
			case 127:
				...
				else if (ch == 'a') {AddCh(); goto case 135;}
				else {goto case 0;}
			case 128:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'k' || ch >= 'm' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'l') {AddCh(); goto case 136;}
				else {goto case 0;}
			case 129:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
			...
			case 131:
				...
				else if (ch == 'e') {AddCh(); goto case 138;}
				else {goto case 0;}
			case 132:
			...
			case 133:
				...
				else if (ch == 'n') {AddCh(); goto case 139;}
				else {goto case 0;}
			case 134:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'f' || ch >= 'h' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'g') {AddCh(); goto case 140;}
				else {goto case 0;}
			case 135:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 't') {AddCh(); goto case 141;}
				else {goto case 0;}
			case 136:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'e') {AddCh(); goto case 142;}
				else {goto case 0;}
			case 137:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'S' || ch >= 'U' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'T') {AddCh(); goto case 143;}
				else {goto case 0;}
			case 138:
			...
			case 139:
				...
				else if (ch == 'g') {AddCh(); goto case 144;}
				else {goto case 0;}
			case 140:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'e') {AddCh(); goto case 145;}
				else {goto case 0;}
			case 141:
			...
			case 142:
				...
				else if (ch == 'a') {AddCh(); goto case 146;}
				else {goto case 0;}
			case 143:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == ':') {apx++; AddCh(); goto case 9;}
				else if (ch == 'i') {AddCh(); goto case 147;}
				else {goto case 0;}
			case 144:
			...
			case 150:
				...
				else if (ch == 'e') {AddCh(); goto case 151;}
				else {goto case 0;}
			case 151:
